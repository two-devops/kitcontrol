        ...
        for folder in self.folders:
            if self.path != self.characters:
                ...
                if folder == self.config.config_folder:
                    ...
                    self.system.mkfile(path, self.config.config_file_name, self.config.load_file_config)
            else:
                ...
                if folder == self.config.config_folder:
                    self.system.mkfile(self.config.config_folder, self.config.config_file_name, self.config.load_file_config)
